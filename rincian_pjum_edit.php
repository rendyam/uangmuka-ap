<?PHP
    ...
    $txtKodePJUM = base64_decode($_GET['id3']);
    $txtRincian = "";            
    $txtQty = ""; 
    $txtHarga = "";
    ...
    if (isset($_POST['btnSimpan']) and $_SERVER['REQUEST_METHOD'] == "POST") {
        try {
            ...
            if($txtQty=="" || $txtHarga==""){
                ...
                $sqlQuery = $db->prepare("update t_um_detail_tab set qty_pj = :qty_pengajuan, harga_pj = :harga_pengajuan where t_um_detail_id = :t_um_detail_id and t_um_id = :t_um_id");
                ...
                if($sqlQuery->rowCount() > 0){
                    header('location:pjum_edit.php?id='.base64_encode($txtKodePJUM));
