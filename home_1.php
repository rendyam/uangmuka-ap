<?PHP
    ...
    try {
        ...
        if($_SESSION['sessevaluangmuka']==1){
            $query = "SELECT t_um_id, tgl_pjum, keperluan, status_pjum, nilai_um, evaluasi_nilai_um, tgl_diterima, t_pjum_id, nilai_pjum, aging, divisions.name from t_um_rpt LEFT JOIN divisions ON t_um_rpt.divisi = divisions.id where status_pjum <> 'Approved' order by tgl_um";
        }else{
