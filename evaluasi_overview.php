<?PHP
    ...
    try {
        ...
        $query = "SELECT t_um_id, tgl_um, keperluan, status_um, nilai_um, evaluasi_nilai_um, tgl_diterima, divisions.NAME AS nama_divisi from t_um_rpt LEFT JOIN divisions ON t_um_rpt.divisi=divisions.id where status_um in ('Verification') order by tgl_um";
            ...
            while ($row = $result->fetch(PDO::FETCH_NUM)) {
                ...
                if($row[3]=='Verification'){
                    $str = $str."<td class='center'>
                            <a class='btn btn-success' href='evaluasi_edit.php?id=$row[0]'>
