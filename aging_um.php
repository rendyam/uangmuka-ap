<?PHP
    ...
    try {
        ...
        if($_SESSION['sessuangmukaro']==1){
            $query = "SELECT t_um_id, tgl_um, keperluan, status_um, nilai_um, evaluasi_nilai_um, tgl_diterima, t_pjum_id, nilai_pjum, aging from t_um_rpt where status_um = 'Received by User' and (status_pjum <> 'Approved' or status_pjum is null) order by tgl_um";
	...
	<div class="page-content">
            ...
            <div class="container-fluid">
                <div class="box-typical box-typical-padding">
                    ...
                    <h2 class="with-border"><?PHP echo "<a href='print_excel_aging_um.php' target='_blank'><i class='fa fa-file-excel-o'></i> Export Excel</a>";?></h2>
