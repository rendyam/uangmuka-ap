<?php
    ...
    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('W'.$rowNya, "Alasan Reject")
            ->setCellValue('X'.$rowNya, "No PJUM")
            ->setCellValue('Y'.$rowNya, "Tgl PJUM")
    ;
    ...
    try {
        ...
        if($num > 0){
            while($row = $result->fetch(PDO::FETCH_NUM)){
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                        ...
                        ->setCellValue("X$rowNya", $row[22])
                        ->setCellValue("Y$rowNya", $row[23])
                ;
        ...
        $objPHPExcel->setActiveSheetIndex(0);
        // Rename sheet
        $objPHPExcel->getActiveSheet()->setTitle('UM');
        // Set active sheet index to the first sheet, so Excel opens this as the first sheet
        $objPHPExcel->setActiveSheetIndex(0);
